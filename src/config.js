...
${module.exports.SUDO_STRING}iptables -t nat -A POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS} -o eth0 -j MASQUERADE;
${module.exports.SUDO_STRING}iptables -A INPUT -p udp -m udp --dport ${module.exports.WG_PORT} -j ACCEPT;
